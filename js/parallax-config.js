$(document).ready(function(){
	...
	$("#links").parallax("50%", 5360, 0.1, true);
	$("#contact").parallax("50%", 6110, 0.1, true);
...
//	$("#home .pximage5").parallax("50%", 1000, 1.5, true);
	...
	$("#contact .pxmyspace").parallax("50%", 7000, 0.7, true);
	$("#contact .pxmail").parallax("50%", 7110, 1.2, true);
	$("#contact .pxdribbble").parallax("50%", 6910, 0.5, true);
